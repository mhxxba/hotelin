		...
		<div class="col-12">
			...
			<div class="mb-3">
				<div class="d-flex justify-content-start">
					<div class="p-1">
						<a
							href="<?= site_url('administrator/hotel/detail?type=hotel&code='.$hotel->code) ?>"
					...
					<div class="p-1">
						<button
							...
							onclick="getAdd('roomNumber', `<?= $code ?>`)"
						>
			...
			<div class="table-responsive">
				<table class="table table-bordered" id="table-hotel">
					...
					<tbody>
						<?php $no = 0; foreach($roomNumber as $roomNumbers) : $no++ ?>

							<tr>
								<td class="text-end"><?= $no ?></td>
								<td class="text-center"><?= $roomNumbers->number ?></td>
								<td class="text-center"><?= $roomNumbers->status_name ?></td>
								<td class="text-center">
									<div class="d-flex justify-content-center">
										<button
											type="button"
											class="btn btn-warning"
											onclick="getEdit('roomNumber', '<?= $roomNumbers->code ?>')"
										>
											Edit
										</button>
									</div>
